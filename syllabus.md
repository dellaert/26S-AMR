...
- Derive kinematic and dynamic models of common mobile robots  
- Interpret mathematical models of range, vision, and inertial sensors  
- Design SLAM algorithms for various sensor modalities  
- Implement real-time navigation algorithms for different mobile robots  
- Apply and develop these methods in your own research  

### Prerequisites
For undergrads:
- **CS 3630**: Introduction to Robotics Perception
